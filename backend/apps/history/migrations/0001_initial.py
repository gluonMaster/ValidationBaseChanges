...
# Initial migration for history app - HistoryEvent model
...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        default=dict,
                        help_text='JSON structure of changes: '
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        default='',
                        help_text='Original history string segment from AZ/Value52. '
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=['record', 'event_time'],
                name='history_eve_record__aa057f_idx',
            ),
        ),
        migrations.AddIndex(
            model_name='historyevent',
            index=models.Index(
                ...
                name='history_eve_event_t_f5fcab_idx',
            ),
        ),
    ]
